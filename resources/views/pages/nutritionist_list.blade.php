...
<div class="container-fluid  dashboard-content">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                <h2 class="pageheader-title">Ver Nutricionistas</h2>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <table class="display table table-hover table-striped" style="width:100%">
                            ...
                            <tr data-patient-id='{{ $user->id }}' onclick='editNutritionist({{ $user->id }})' style="cursor: pointer">
                                <td>{{ ++$i }}</td>
                                <td>{{$user->name}}</td>
                                <td>{{$user->phone}}</td>
                                <td>{{$user->dob}}</td>
    ...
    <div class="modal" id="nutritionistModal" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="smallmodalLabel">Editar Nutricionistas</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <form method="post" action="{{ route('nutricionistas_update') }}"  id="client-form">
                                @csrf
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Id Nutricionista: </label>
                                    <div class="col-12 col-sm-10 col-lg-8">
                                        <input type="hidden" name="id" id="mnutriIdhidden">
                                        <input type="text" required="" name="ids" id="mnutriId" class="form-control" disabled>
