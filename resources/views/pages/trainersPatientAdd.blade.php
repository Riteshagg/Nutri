        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Nome Patient</h2>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('trainer_patient_store') }}" method="post" id="form">
                            @csrf
                            ...
                            @if (count($trainers))
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <select class="form-control" id="patientNutritionistDropdown" name="trainerSelect">
                                            <option value="" disabled selected>Selecionar Trainer</option>
