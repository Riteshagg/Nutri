...
function editPatient(id) {
    ...
    if (!clicked) { //this prevents request spam
        clicked = true;
        $.ajax({
            url: '/nut_sol/public/ajaxTrainerPatients',
            type: "get",
            data: {
                id: id,
            },
            ...
            success: function (responseJson) {
               ...
               let elmID =  document.querySelector("#patientTrainerDropdown")
               if(elmID){
                   elmID.value = obj.trainerId;
               }
                ...
                document.querySelector("#mpdelete").href = "trainer-patient-delete/"+obj.id;
